...
<body style="background-image: url(images/issued.jpg); opacity: 0.9;">
    ...
    <section>
        ...
        $res1 = mysqli_query($db, "SELECT ir.id, ir.book_id, ir.mem_id, b.name, m.username, b.authors,
                 ir.issue_date, ir.due_date, ir.return_date, ir.status, b.quantity  FROM
                  issue_return ir, books b, msignup m WHERE ir.mem_id=$_SESSION[login_member] AND ir.status like '%returned%' AND b.bid=ir.book_id AND m.id= ir.mem_id");
